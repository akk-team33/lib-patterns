 ...
 * E.g. {@link de.team33.patterns.exceptional.e1.XFunction} as a variant of {@link java.util.function.Function}.
 * <p>
 * In addition, it contains tools and utilities that enable the functional constructs defined here to be converted
 * into their simple form. For example, an {@link de.team33.patterns.exceptional.e1.XFunction} can be converted
