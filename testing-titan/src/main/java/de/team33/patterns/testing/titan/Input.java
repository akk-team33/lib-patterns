 ...
 * @see Parallel#report(Condition, Operation)
 * @see Parallel#stream(int, Operation)
 * @see Parallel#stream(Condition, Operation)
 */
public class Input {
    ...
    public Input(final int threadIndex, final int operationIndex, final int loopIndex) {
