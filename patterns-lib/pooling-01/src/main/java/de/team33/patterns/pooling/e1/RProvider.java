 ...
 * @see XProvider
 */
public class RProvider<S> extends Mutual<Recent<S>, RuntimeException> {

    /**
     * Initializes a new instance giving a {@link Supplier} that defines the intended initialization of a
     * new <em>subject</em>.
     */
    public RProvider(final Supplier<S> newItem, final long maxIdle, final long maxLiving) {
        super(() -> new Recent<S>(newItem, maxIdle, maxLiving));
    }
