 ...
 * </pre>
 * <p>
 * *CAUTION: there is a problem simply deriving it from {@link java.util.Random} when using Java 17 or higher!
 * In that case you should define a member of type {@link java.util.Random} and use it to implement the method
 * {@link de.team33.patterns.arbitrary.mimas.Generator#nextBits(int)}.
 * <p>
