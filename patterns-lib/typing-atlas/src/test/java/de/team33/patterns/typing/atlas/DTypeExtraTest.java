...
class DTypeExtraTest {

    @Test
    void getActualParameter_unknown() {
        try {
            final DType result = ClassCase.toTypedef(Integer.class).getActualParameter("E");
    ...
    void getActualParameter_definite() {
        final DType result = ClassCase.toTypedef(StringList.class)
    ...
    void getActualParameter_indefinite() {
        try {
            final DType result = ClassCase.toTypedef(List.class)
                                          .getActualParameter("E");
            fail("expected to Fail - but was " + result);
