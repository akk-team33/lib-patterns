...
class FeaturesTest {
    ...
    @Test
    final void get() {
        assertNull(features.peek(Key.TO_LIST, null));
    ...
    final void peek() {
        assertNull(features.peek(Key.TO_LIST, null));
        assertNull(features.peek(Key.TO_STRING, null));
        final String expected = features.get(Key.TO_STRING, () -> toList().toString());
        final String result = features.peek(Key.TO_STRING, null);
        assertNotNull(features.peek(Key.TO_LIST, null));
        assertNotNull(features.peek(Key.TO_STRING, null));
