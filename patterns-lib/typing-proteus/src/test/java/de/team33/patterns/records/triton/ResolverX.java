...
final class ResolverX {

    private final Type<?> targetType;
    private final Mapping mapping;

    private ResolverX(final Type<?> targetType) {
    ...
    static Object resolve(final Type<?> targetType, final JsonValue value) {
        return new ResolverX(targetType).apply(value);
    }
    ...
    private enum Mapping {
        ...
        BOOLEAN(isOneOf(boolean.class, Boolean.class), JsonBoolean.class, ResolverX::mapBoolean),
        BYTE(isOneOf(byte.class, Byte.class), JsonNumber.class, ResolverX::mapByte),
        SHORT(isOneOf(short.class, Short.class), JsonNumber.class, ResolverX::mapShort),
        INT(isOneOf(int.class, Integer.class), JsonNumber.class, ResolverX::mapInt),
        LONG(isOneOf(long.class, Long.class), JsonNumber.class, ResolverX::mapLong),
        FLOAT(isOneOf(float.class, Float.class), JsonNumber.class, ResolverX::mapFloat),
        DOUBLE(isOneOf(double.class, Double.class), JsonNumber.class, ResolverX::mapDouble),
        BIG_INT(BigInteger.class::equals, JsonNumber.class, ResolverX::mapBigInteger),
        BIG_DEC(BigDecimal.class::equals, JsonNumber.class, ResolverX::mapBigDecimal),
        CHAR(isOneOf(char.class, Character.class), JsonString.class, ResolverX::mapChar),
        STRING(String.class::equals, JsonString.class, ResolverX::mapString),
        ENUM(Class::isEnum, JsonString.class, ResolverX::mapEnum),
        ARRAY(Class::isArray, JsonArray.class, ResolverX::mapArray),
        RECORD(Class::isRecord, JsonObject.class, ResolverX::mapRecord),
        STRINGABLE(Stringable::supports, JsonString.class, ResolverX::mapStringable);
        ...
        final Function<JsonValue, Object> method(final ResolverX resolver) {
        ...
        interface Method<T extends JsonValue> {
            ...
            Object mapT(ResolverX resolver, T value);

            @SuppressWarnings("unchecked")
            default Object map(final ResolverX resolver, final JsonValue value) {
    ...
    private final class RecordMapper {
        ...
        private RecordMapper() {
            this.description = TritonX.description((Type) targetType);
        }
        ...
        final Object map(final JsonObject source) {
            ...
            return TritonX.toRecord(description.type(), stage);
        }
