 ...
 *
 * @see de.team33.patterns.arbitrary.tyche package
 */
...
public interface Generator extends BitGenerator {
     ...
     * intended as a result of {@link #anyBits(int)}.
     */
     ...
     * <p>
     * A typical implementation will return a {@code byte} value, with each possible value being equally probable.
     * <p>
     * The default implementation depends on the implementation of {@link #anyBits(int)}.
     */
     ...
     * <p>
     * A typical implementation will return a {@code short} value, with each possible value being equally probable.
     * <p>
     * The default implementation depends on the implementation of {@link #anyBits(int)}.
     */
     ...
     * <p>
     * A typical implementation will return an {@code int} value, with each possible value being equally probable.
     * <p>
     * The default implementation depends on the implementation of {@link #anyBits(int)}.
     */
    default int anyInt() {
    ...
    /**
     * Returns an arbitrary {@code int} value between {@code zero} (incl.) and {@code bound} (excl.).
     * <p>
     * A typical implementation will return an {@code int} value within the defined bounds,
    ...
    /**
     * Returns an arbitrary {@code int} value between {@code min} (incl.) and {@code bound} (excl.).
     * <p>
     * A typical implementation will return an {@code int} value within the defined bounds,
     * with each possible value being equally probable.
     * <p>
     ...
     * Returns an arbitrary {@code int} value between {@code zero} (incl.) and {@code bound} (excl.).
     * <p>
     * A typical implementation will return a {@code int} value within the defined bounds,
     ...
     * <p>
     * A typical implementation will return a {@code long} value,
     * with each possible value being equally probable.
     * <p>
     * The default implementation depends on the implementation of {@link #anyBits(int)}.
     */
    ...
    /**
     * Returns an arbitrary {@code long} value between {@code zero} (incl.) and {@code bound} (excl.).
     * <p>
     * A typical implementation will return a {@code long} value within the defined bounds,
     * with each possible value being equally probable.
     * <p>
     * The default implementation depends on the implementation of {@link #anyBits(int)}.
     */
    ...
    /**
     * Returns an arbitrary {@code long} value between {@code min} (incl.) and {@code bound} (excl.).
     * <p>
     * A typical implementation will return a {@code long} value within the defined bounds,
     * with each possible value being equally probable.
     * <p>
     ...
     * <p>
     * A typical implementation will return a {@link BigInteger} value within the defined bounds,
     * with each possible value being equally probable.
     * <p>
     * The default implementation depends on the implementation of {@link #anyBits(int)}.
     */
     ...
     * Returns a {@link BigInteger} value between {@link BigInteger#ZERO} (incl.) and {@code bound} (excl.).
     * <p>
     * A typical implementation will return a value within the defined bounds, with smaller values
    ...
    /**
     * Returns an arbitrary {@code char} value of a predefined character set.
     * <p>
     * A typical implementation will return a {@code char} value within the predefined character set,
     * with each possible value being equally probable.
     * <p>
    ...
    /**
     * Returns an arbitrary {@code char} value of the given {@code characters}.
     * <p>
     * A typical implementation will return a {@code char} value within the given characters,
     * with each possible value being equally probable.
     * <p>
     * The default implementation depends on the implementation of {@link #anyBits(int)}.
     *
