/**
 * Provides generation of arbitrary values of virtually any type, mainly for testing purpose.
 * <p>
 ...
 * {@link de.team33.patterns.arbitrary.tyche.Generator} interface, which makes other basic methods available.
 ...
 * </pre>
 * <p>
 * In this example, the {@link de.team33.patterns.arbitrary.tyche.Charger} and
 * {@link de.team33.patterns.arbitrary.tyche.Initiator} interfaces are used to charge/initiate the complex,
 * contextual types (Person, Customer, Employee, ...) with random content.
 *
 * @see <a href="https://de.wikipedia.org/wiki/(258)_Tyche" target="_blank">Tyche (Asteroid)</a>
 * @see <a href="https://de.wikipedia.org/wiki/Tyche" target="_blank">Tyche (Mythologie)</a>
 */
